...
/** @defgroup STM32F401_DISCOVERY_L3GD20_Exported_Types
  * @{
  */
...
/** @defgroup STM32F401_DISCOVERY_L3GD20_Exported_Constants
  * @{
  */
...
/* Uncomment the following line to use the default L3GD20_TIMEOUT_UserCallback()
   ...
   occured during communication (waiting transmit data register empty flag(TXE)
...
/** @defgroup STM32F401_DISCOVERY_L3GD20_Exported_Macros
  * @{
  */
...
/** @defgroup STM32F401_DISCOVERY_L3GD20_Exported_Functions
  * @{
  */
...
/* L3GD20_TIMEOUT_UserCallback() function is called whenever a timeout condition
   ...
   define USE_DEFAULT_TIMEOUT_CALLBACK in stm32f401_discovery_l3gd20.h file.
